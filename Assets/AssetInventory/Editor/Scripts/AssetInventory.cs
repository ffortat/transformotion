...
namespace AssetInventory
{
    ...
    {
        public const string TOOL_VERSION = "1.11.0";
        ...
        public static string GetAssetDownloadPath()
        {
            ...
            // custom special location (Unity 2022+) overrides default as well
            ...
            if (!string.IsNullOrWhiteSpace(customLocation)) return customLocation;
